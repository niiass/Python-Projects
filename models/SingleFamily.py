"""
SingleFamily is child class of RealEstate

__init__:
It calls __init__ method of RealEstate class and specifies residential type: "Single Family"
This method is used to create SingleFamily type objects
...
class SingleFamily(RealEstate):
    ...
    def display_info(self):
        return f"Single Family - {super().display_info()}"