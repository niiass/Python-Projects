"""
TwoFamily is child class of RealEstate

__init__:
It calls __init__ method of RealEstate class and specifies residential type: "Two Family"
This method is used to create TwoFamily type objects
...
class TwoFamily(RealEstate):
    ...
    def display_info(self):
        return f"Two Family - {super().display_info()}"